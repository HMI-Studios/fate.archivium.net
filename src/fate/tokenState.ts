...
// token gets its own copy of the stats that change in play (stress, consequences, fate
// points), laid over the monster's sheet, which still supplies skills and everything
// else. The copies are scoped to the scene: they live in its live doc (the
...
export const TOKEN_STATE_KEYS = ['stress', 'consequences', 'fatePoints'] as const;
